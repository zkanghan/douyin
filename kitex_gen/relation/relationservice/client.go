...
type Client interface {
	...
	MgetFollow(ctx context.Context, req *relation.MGetFollowRequest, callOptions ...callopt.Option) (r *relation.MGetFollowResponse, err error)
}
...
func (p *kRelationServiceClient) MgetFollow(ctx context.Context, req *relation.MGetFollowRequest, callOptions ...callopt.Option) (r *relation.MGetFollowResponse, err error) {
	ctx = client.NewCtxWithCallOptions(ctx, callOptions)
